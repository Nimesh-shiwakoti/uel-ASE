...
--
-- Host: localhost:3306
-- Generation Time: Nov 24, 2025 at 12:21 PM
...
(5, '114175027455096814356', 'chedurthipati bhargavi', 'chedurthipatibhargavi@gmail.com', 'https://lh3.googleusercontent.com/a/ACg8ocJLs3ExD3Wbs7kBqrFBq-wkX01RZ036k59uTYXL-xypzeF51w=s96-c', '2025-11-19 17:42:03');
...
INSERT INTO `orders` (`order_id`, `customer_id`, `street_address`, `city`, `postal_code`, `phone_number`, `order_date`, `total_amount`, `payment_status`, `payment_method`, `invoice_number`) VALUES
(1, 1, 'Birtabazar, Birtamode-3', 'Birtamode', '57204', '09804944992', '2025-11-20 01:09:54', 65.00, 'Paid', 'Card', 'INV-691E5C521FE01'),
(2, 1, 'Birtabazar, Birtamode-3', 'Birtamode', '57204', '9804944992', '2025-11-20 01:54:26', 80.00, 'Paid', 'Card', 'INV-E416065BCC4D'),
(3, 1, 'Birtabazar, Birtamode-3', 'Birtamode', '57204', '9804944992', '2025-11-20 01:58:13', 80.00, 'Paid', 'Card', 'INV-098C73CC5F96'),
(4, 2, '46 Cryol Road', 'Ashford', 'TN23 5AS', '23434342', '2025-11-20 02:00:28', 315.00, 'Paid', 'Card', 'INV-9BFFE1938CD2'),
(5, 1, 'Birtabazar, Birtamode-3', 'Birtamode', '57204', '9804944992', '2025-11-20 02:13:26', 180.00, 'Paid', 'Card', 'INV-0EBA8E0521A1');
...
CREATE TABLE `order_tracking` (
  ...
  `order_id` int(11) NOT NULL,
  `status` enum('Pending','Processing','Packaging','Out for Delivery','Delivered') DEFAULT 'Pending',
...
(329, 121, 40.00, 40.00, '2025-11-20', 1),
(330, 201, 25.00, 25.00, '2025-11-20', 1);
...
--
ALTER TABLE `purchases`
  MODIFY `purchase_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=331;
